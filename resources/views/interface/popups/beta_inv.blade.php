<div class="modal fade beta-inv popup" id="global-beta-inv-popup" tabindex="-1" role="dialog" aria-labelledby="global-beta-inv-popup">

  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
				<div class="page-header mt-025">
					<h1 class="mt-0">Want exclusive access to test our new website?</h1>
				</div>
              ...
              @foreach($GLOBAL_CAUSES as $cause)
					...
					<button id="donate" class="btn btn-primary btn-block">Donate</button>
